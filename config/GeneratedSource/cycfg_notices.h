...
#if !defined(CYB06447BZI_BLD53)
#error "Unexpected MPN; expected DEVICE:=CYB06447BZI-BLD53. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYB06447BZI_BLD53) */
